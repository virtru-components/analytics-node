...
// This code allows for injection of a customized `superagent` object from
// a parent closure.  This is ugly...
var request = require('superagent');
if (typeof componentRequest != 'undefined') {
...
Analytics.prototype.enqueue = function(type, message, fn){
  ...
  // Chaanges this to not need lodash
  message.context = message.context || { library: { name: 'analytics-node', version: version }};
